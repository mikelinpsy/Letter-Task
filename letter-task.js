...
var test_stimuli = [{
    ...
    {
        stimulus: repo_site + "img/lobal_h_f.png", // Change 3: Adding `repo_site` in `test_stimuli`
        data: {
            test_part: 'test',
            correct_response: 'h'
        }
    ...
    {
        stimulus: repo_site + "img/lobal_h_l.png", // Change 3: Adding `repo_site` in `test_stimuli`
        data: {
            test_part: 'test',
            correct_response: 'h'
        }
    ...
    {
        stimulus: repo_site + "img/lobal_t_f.png", // Change 3: Adding `repo_site` in `test_stimuli`
        data: {
            test_part: 'test',
            correct_response: 't'
        }
    ...
    {
        stimulus: repo_site + "img/lobal_t_l.png", // Change 3: Adding `repo_site` in `test_stimuli`
        data: {
            test_part: 'test',
            correct_response: 't'
        }
